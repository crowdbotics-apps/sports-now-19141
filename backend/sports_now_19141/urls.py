"""sports_now_19141 URL Configuration
...
admin.site.site_header = "Sports Now"
admin.site.site_title = "Sports Now Admin Portal"
admin.site.index_title = "Sports Now Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Sports Now API",
        default_version="v1",
        description="API documentation for Sports Now App",
    ),
    public=True,
